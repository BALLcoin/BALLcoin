...
bool CWalletDB::WriteZBALLSeed(const uint256& hashSeed, const vector<unsigned char>& seed)
{
...
bool CWalletDB::ReadZBALLSeed(const uint256& hashSeed, vector<unsigned char>& seed)
{
