...
// Copyright (c) 2020-2021 The BALLcoin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints = {
    {0, uint256S("00000d6bc59a8610645cc532d115be19a8d909f41eda264313a7cf4120e3eaef")},
    {10000, uint256S("834967747a125eff66221c2803b44aef195a9bd045d268f7b0e6483637742611")},
    {104500, uint256S("132700b5519c1fa48a582516fd5a6cb9de8bd2fbebcd1ed477867cb6765b7f03")},
    {150000, uint256S("7073f50148217d609165e262b54ce06ffaf2c2d0bc6dda46b3c3bc042dffaa52")},
    {200000, uint256S("7899a25ee0e0aedd45d5c257a118c6ef3a35be456e44b4a7f925b999bb524893")},
    {250000, uint256S("b1a19509095b153b513c52eba5a36be8024e9d17b20f4a71060903eecfb60692")},
    {275000, uint256S("e67317e3903aaab5efc08884ed97897df3ab37de1d2296c09e238c7e781541c4")},
    {288000, uint256S("4e3e3d9260c6eb70b6e2ffc80ee2512dcf8360df6a83295a97f18c2703de2c76")},
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1598786791, 2238119, 0x1e0ffff0, 1, 1 * COIN);
        // genesis = CreateGenesisBlock(1598786791, 2238119, 0x1e0ffff0, 1, 1); // original genesis block not created with 1 x coin...
        consensus.hashGenesisBlock = genesis.GetHash();

        printf("Hash:  %s\n", consensus.hashGenesisBlock.ToString().c_str());
        // printf("CalcHash:  %s\n", calchashGenesisBlock.ToString().c_str());
        printf("MarkleRoot:  %s\n", genesis.hashMerkleRoot.ToString().c_str());


        // assert(consensus.hashGenesisBlock == uint256S("d1e03b7dafd6d91b5e723b5f68ba96c8c79b729d55de47b58838d7f441373490"));

        assert(consensus.hashGenesisBlock == uint256S("00000d6bc59a8610645cc532d115be19a8d909f41eda264313a7cf4120e3eaef"));
        assert(genesis.hashMerkleRoot == uint256S("b9694e0b1df7aac3a5505f4c7a4f231bca874eb5dc32c19e3dcfaf635d053727"));
        ...
        // spork keys
        consensus.strSporkPubKey = "042d34a6632a386aed9f7b74961ce3eff4bdf40d2bf6575826174f1825080b6c9cac7f84b7bd1eb9347031ebb6f05a5328d796eff2eb0d8c101a75b8bc8f0ab401";
        consensus.strSporkPubKeyOld = "042d34a6632a386aed9f7b74961ce3eff4bdf40d2bf6575826174f1825080b6c9cac7f84b7bd1eb9347031ebb6f05a5328d796eff2eb0d8c101a75b8bc8f0ab401";
        ...
        consensus.height_last_invalid_UTXO = 40000000;
        consensus.height_last_ZC_AccumCheckpoint = 40000000;
        consensus.height_last_ZC_WrappedSerials = 40000000;
        consensus.height_ZC_RecalcAccumulators = 40000000;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_POS].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_ZC].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_V2].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight = 40000000;
        consensus.vUpgrades[Consensus::UPGRADE_V5_3].nActivationHeight = 40000000;
        ...
        vSeeds.emplace_back("seed1.ball-coin.com", true); // Primary DNS Seeder from matwater
        vSeeds.emplace_back("seed2.ball-coin.com", true); // Secondary DNS Seeder from matwater
...
public:
    CTestNetParams()
    {
        ...
        printf("Hash: %c", consensus.hashGenesisBlock);
