...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 BALL at the same time
...
enum ZerocoinSpendStatus {
    ...
    ZBALL_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
...
public:
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzBALLTracker> zpivTracker;
    ...
    {
        zwalletMain = zwallet;
        zpivTracker = std::unique_ptr<CzBALLTracker>(new CzBALLTracker(strWalletFile));
    }

    CzBALLWallet* getZWallet() { return zwalletMain; }
