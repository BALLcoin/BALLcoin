                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBALLPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzBALLPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzBALLPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBALLPathCustom.empty()) && nCustomBackupThreshold > 0) {
