#!/usr/bin/env python3
# Copyright (c) 2019 The BALLcoin Core developers
...
from fake_stake.base_test import BALLcoin_FakeStakeTest

class zBALLwrappedSerialsTest(BALLcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBALLs..." % DENOM_TO_USE)
