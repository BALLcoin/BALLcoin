BALLcoin Core version *3.2.2* is now available from:  <https://github.com/ballcoin-project/ballcoin/releases>

This is a new minor version release, including various bug fixes and performance improvements.

Please report bugs using the issue tracker at github: <https://github.com/ballcoin-project/ballcoin/issues>


Supplemental Update
==============

BALLcoin Core v3.2.2 is a **supplemental update** to v3.2.0/1 containing minor bug fixes. Users are still advised to read the [v3.2.0 Release Notes](https://github.com/BALLcoin-Project/BALLcoin/blob/master/doc/release-notes/release-notes-3.2.0.md) to familiarize themselves with the major feature changes.
