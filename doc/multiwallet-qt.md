...
In order to support loading of multiple wallets in ballcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ballcoin.cpp.
...
Changes to ballcoin.cpp
----------------------
ballcoin.cpp is the entry point into ballcoin-qt, and as such, will require some minor modifications to provide hooks for
