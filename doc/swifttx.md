...
This mechanism has been integrated into Bitcore-Node-BALLcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BALLcoin-Project/insight-api-ballcoin#web-socket-api](https://github.com/BALLcoin-Project/insight-api-ballcoin#web-socket-api) 
* API: [https://github.com/BALLcoin-Project/insight-api-ballcoin#swifttx-transactions](https://github.com/BALLcoin-Project/insight-api-ballcoin#swifttx-transactions) 
...
By default, the BALLcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BALLcoin Core daemon:
